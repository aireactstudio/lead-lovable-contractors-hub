...
export default function LeadTable({ leads, onUpdateStatus, onUpdateScore }: LeadTableProps) {
        ...
        <table className="w-full border-collapse">
          ...
          <tbody className="divide-y divide-gray-200">
            {leads.map((lead) => (
              <tr 
                key={lead.id} 
                className="bg-white hover:bg-muted/50 transition-colors cursor-pointer"
